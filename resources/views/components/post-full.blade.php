                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-sm text-gray-500">
                        <a href="javascript:void(0)" class="hover:underline">
                            <time
                                datetime="2020-12-08T17:34:00">{{ $post->created_at->diffForHumans() }}</time>
                        </a>
                    </p>
                </div>
                <div class="flex flex-shrink-0 self-center">
                    ...
                    >
                        ...
                        <div
                            ...
                            aria-orientation="vertical" aria-labelledby="options-menu-5-button"
                            tabindex="-1"
                            x-show="open"
                        ...
                        >
                            <div class="py-1" role="none">
                                <a href="javascript:void(0)"
                                   ...
                                   role="menuitem" tabindex="-1" id="options-menu-5-item-0"
                                >
                                ...
                                <a href="javascript:void(0)"
                                   class="text-gray-700 flex px-4 py-2 text-sm"
                                   role="menuitem" tabindex="-1" id="options-menu-5-item-1"
                                >
                                    <svg class="mr-3 h-5 w-5 text-gray-400"
                                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                         fill="currentColor" aria-hidden="true">
                                ...
                                <a href="javascript:void(0)"
                                   class="text-gray-700 flex px-4 py-2 text-sm"
                                   role="menuitem" tabindex="-1" id="options-menu-5-item-2"
                                >
                                    <svg class="mr-3 h-5 w-5 text-gray-400"
                                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                         fill="currentColor" aria-hidden="true">
                                        <path
                                            d="M3.5 2.75a.75.75 0 00-1.5 0v14.5a.75.75 0 001.5 0v-4.392l1.657-.348a6.449 6.449 0 014.271.572 7.948 7.948 0 005.965.524l2.078-.64A.75.75 0 0018 12.25v-8.5a.75.75 0 00-.904-.734l-2.38.501a7.25 7.25 0 01-4.186-.363l-.502-.2a8.75 8.75 0 00-5.053-.439l-1.475.31V2.75z"></path>
                                    </svg>
